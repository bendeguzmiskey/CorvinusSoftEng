...
namespace MintaZh.Models
{
    public partial class ReceptContext : DbContext
    {
        ...
        public virtual DbSet<Fogasok> Fogasok { get; set; } = null!;
        public virtual DbSet<MennyisegiEgysegek> MennyisegiEgysegek { get; set; } = null!;
        public virtual DbSet<Nyersanyagok> Nyersanyagok { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Nyersanyagok>(entity =>
            {
                ...
                entity.HasOne(d => d.MennyisegiEgyseg)
                    .WithMany(p => p.Nyersanyagok)
            ...
            modelBuilder.Entity<Receptek>(entity =>
            {
                ...
                entity.HasOne(d => d.Fogas)
                    .WithMany(p => p.Receptek)
                    .HasForeignKey(d => d.FogasId)
                    .HasConstraintName("FK_Receptek_Fogasok");

                entity.HasOne(d => d.Nyersanyag)
                    .WithMany(p => p.Receptek)
